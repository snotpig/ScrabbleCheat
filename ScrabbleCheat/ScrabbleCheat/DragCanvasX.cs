...
namespace Snotsoft.Controls
{
    public class DragCanvasX : Canvas
    {
		#region Data
        ...
        // Stores a reference to the last UIElement dragged by the user.
        private UIElement elementLastDragged;
...
//        private double
        ...
        public static readonly DependencyProperty BringDraggedToFrontProperty;
		...
		static DragCanvasX()
		{
            ...
            BringDraggedToFrontProperty = DependencyProperty.Register(
                "BringDraggedToFront",
                typeof( bool ),
                typeof( DragCanvasX ),
                new UIPropertyMetadata( true ) );
		...
		public UIElement ElementBeingDragged
		{
			...
			protected set
			{
				...
				{
					if( DragCanvasX.GetCanBeDragged( value ) )
					{
		...
		public UIElement FindCanvasChild( DependencyObject depObj )
		{
            ...
            #region GetLastDragged

        /// <summary>
        /// Returns the UIElement last dragged
        /// </summary>
        public UIElement GetLastDragged()
        {
            return elementLastDragged;
        }

            #endregion // GetLastDragged

            #region GetLastLocation

        /// <summary>
        /// Returns the original loacation 
        /// of the UIElement last dragged
        /// </summary>
        public Point GetLastLocation()
        {
            ...
            #endregion // GetLastLocation

            #region BringDraggedToFront

        /// <summary>
        /// Gets/sets whether elements in the DragCanvas should be 
        /// brought to the front when dragged.
        /// The default value is true.  This is a dependency property.
        /// </summary>
        public bool BringDraggedToFront
        {
            get { return (bool)base.GetValue(BringDraggedToFrontProperty); }
            set { base.SetValue(BringDraggedToFrontProperty, value); }
        }

            #endregion // BringDraggedToFront
        ...
        protected override void OnPreviewMouseLeftButtonDown( MouseButtonEventArgs e )
		{
            ...
            // Bring element being dragged to front
            if (this.BringDraggedToFront)
            {
                this.BringToFront(this.ElementBeingDragged); // <<<<<<
            }

			// Get the element's offsets from the four sides of the Canvas.
			this.left = Canvas.GetLeft( this.ElementBeingDragged );
            this.right = Canvas.GetRight(this.ElementBeingDragged);
            this.top = Canvas.GetTop(this.ElementBeingDragged);
            this.bottom = Canvas.GetBottom(this.ElementBeingDragged);
		...
		protected override void OnPreviewMouseUp( MouseButtonEventArgs e )
		{
            ...
            this.elementLastDragged = this.ElementBeingDragged;
			this.ElementBeingDragged = null;
		}
